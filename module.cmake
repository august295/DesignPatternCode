...
function(create_target arg0)
    ...
    # 将当前目录下所有源码文件添加到变量
    file (GLOB INC "${CURRENT_FOLDER_ABSOLUTE}/*.h" "${CURRENT_FOLDER_ABSOLUTE}/*.hpp")
    file (GLOB SRC "${CURRENT_FOLDER_ABSOLUTE}/*.c" "${CURRENT_FOLDER_ABSOLUTE}/*.cpp")
